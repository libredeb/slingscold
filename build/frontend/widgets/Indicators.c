/* Indicators.c generated by valac 0.16.1, the Vala compiler
...
static gboolean __lambda11_ (SlingshotFrontendIndicators* self);
...
static gboolean _slingshot_frontend_indicators_draw_background_gtk_widget_expose_event (GtkWidget* _sender, GdkEventExpose* event, gpointer self) {
	gboolean result;
	result = slingshot_frontend_indicators_draw_background (self, _sender, event);
	return result;
}
...
void slingshot_frontend_indicators_append (SlingshotFrontendIndicators* self, const gchar* thelabel) {
	...
	label = _tmp4_;
	gdk_color_parse ("#FFFFFF", &_tmp5_);
	white = _tmp5_;
	_tmp6_ = white;
	gtk_widget_modify_fg ((GtkWidget*) label, GTK_STATE_NORMAL, &_tmp6_);
	_tmp7_ = pango_font_description_new ();
	font = _tmp7_;
	...
	_tmp8_ = slingshot_frontend_utilities_wrap_alignment ((GtkWidget*) label, 5, 15, 5, 15);
	_tmp9_ = _tmp8_;
	gtk_container_add ((GtkContainer*) _data2_->indicator, (GtkWidget*) _tmp9_);
	_g_object_unref0 (_tmp9_);
	_tmp10_ = _g_object_ref0 ((GtkWidget*) _data2_->indicator);
	self->children = g_list_append (self->children, _tmp10_);
	...
	g_signal_connect_data ((GtkWidget*) _data2_->indicator, "button-release-event", (GCallback) ___lambda10__gtk_widget_button_release_event, block2_data_ref (_data2_), (GClosureNotify) block2_data_unref, 0);
...
void slingshot_frontend_indicators_change_focus (SlingshotFrontendIndicators* self) {
	...
	_tmp8_ = g_timeout_add_full (G_PRIORITY_DEFAULT, (guint) ((gint) (1000 / SLINGSHOT_FRONTEND_INDICATORS_FPS)), ___lambda11__gsource_func, g_object_ref (self), g_object_unref);
...
static void slingshot_frontend_indicators_finalize (GObject* obj) {
	SlingshotFrontendIndicators * self;
	self = SLINGSHOT_FRONTEND_INDICATORS (obj);
